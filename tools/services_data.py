...
PAGES = {
    ...
    "3d-studio": {
        ...
        "page_css": False,
        "page_css_file": "",
        "schema_name": "3D Visualization Studio",
        "desc": "Photorealistic renders, walkthroughs, 360° virtual tours and sciography studies — for architects, developers and interior clients. In-house 3ds Max. Woodex 3D Studio.",
        "crumbs": '<a href="index.html">Home</a> · <a href="services.html">Services</a> · 3D Studio',

        "hero": {
            "img": "images/studio-hero.jpg",
            "eyebrow": "In-house 3D Studio — 3ds Max · AutoCAD",
            "h1": "3D Visualization Studio in Lahore",
            "lead": "Photorealistic renders, walkthroughs, 360° virtual tours and sciography studies — for architects, developers and interior clients. In-house 3ds Max. Woodex 3D Studio.",
            "cta1": "Start a 3D brief",
            "cta2": "View projects",
            "cta2_href": "projects.html",
            "trust": ["In-House 3ds Max", "2–5 Day Turnaround", "Marketing-Ready", "Serves External Clients"],
        },

        "who": {
            "sub": "Professionals and clients who need visualization — whether or not Woodex is building the project.",
            "cards": [
                ["Architects", "Photorealistic renders, walkthroughs and sciography studies that communicate intent and win approvals."],
                ["Interior designers", "Standalone renders and client-facing animations when your practice does not produce visualization in-house."],
                ["Real estate developers", "Pre-sales renders, virtual tours and flyovers that market units before construction completes."],
                ["Homeowners &amp; investors", "See the home in photorealistic 3D before committing to build — decide materials and finishes on screen."],
                ["Brands &amp; retailers", "Store renders that support rollouts and investor presentations before fit-out begins."],
            ],
        },

        "run": {
            "title": "Brief to Final Output",
            "sub": "A structured production process — confirmed dates, agreed revisions, no surprises.",
            "two_col": False,
            "steps": [
                ["Brief &amp; Reference", "You tell us what to visualize — drawings, concept images, material references and the camera angles you need. We confirm scope, turnaround and quote."],
                ["Modeling &amp; Scene Setup", "The space is modeled in 3ds Max from your drawings or references. Furniture, fixtures and details are built to specification."],
                ["Lighting &amp; Texturing", "Materials and finishes are applied with real-world accuracy. Daylight and artificial lighting reproduce the design intent — or show the scene at its best."],
                ["Render &amp; Delivery", "Final renders are produced in marketing-ready resolution and delivered in the agreed format — on the confirmed date."],
                ["Revisions &amp; Final Output", "Up to two revision rounds are included. Materials, lighting, angles and composition are refined until the output is approved."],
            ],
        },

        "why": {
            "cards": [
                ["In-house 3ds Max &amp; AutoCAD", "The same team that visualizes every Woodex project. Expertise is shared — renders are never outsourced to unknown production."],
                ["Fast, confirmed turnaround", "Basic renders in 2–5 days. Confirmed delivery dates set before work begins — no open-ended timelines, no missed launches."],
                ["Marketing-ready outputs", "Resolution and composition built for client approvals, pre-sales and marketing — not just internal reference."],
                ["Serves external clients", "A standalone service. Architects, designers and developers commission visualization from us even when Woodex is not executing the build."],
                ["10+ years · 200–500 projects", "Every Woodex project is visualized in-house before execution. That experience informs every render."],
                ["Structured revisions, clear quotes", "Two revision rounds included, agreed delivery dates, itemized quotes. The studio runs on process, not promises."],
            ],
        },

        "faq": {
            "items": [
                ["How fast can I get a render?", "Basic interior and exterior renders are typically delivered in 2–5 days. A confirmed delivery date is set at the brief stage, before any work begins."],
                ["What files do I receive?", "Renders are delivered as high-resolution PNG and JPG files — 4K and print-grade available. Animations are delivered as MOV and MP4. Formats are confirmed in the brief."],
                ["How many revisions are included?", "Two revision rounds are included in every brief. Additional rounds and material or finish variants can be commissioned at a per-scene rate."],
                ["Can I commission renders without using Woodex to build?", "Yes. Woodex 3D Studio is a standalone service. Architects, interior designers and developers commission visualization from us even when another practice is executing the build."],
                ["Do you do exterior renders and animations?", "Yes. Photorealistic exterior renders and walkthrough or flyover animations are part of the studio's core scope."],
                ["What is a sciography study?", "A sciography (shadow) study shows sun paths and shadow patterns across a site and building — used for planning approvals, daylight analysis and environmental assessment."],
                ["Do you produce 360° virtual tours?", "Yes. Interactive 360° virtual tours are produced for pre-sales and marketing — viewers can walk a space online from any device."],
                ["What information do you need to start?", "Drawings or concept references, the camera angles you need and your deadline. From that, we confirm scope, turnaround and quote within one business day."],
            ],
        },

        "slide": {
            "title": "Our 3D Visualization Services",
            "sub": "Six services — each running standalone or combined into a full presentation package.",
            "label": "Service",
            "items": [
                {"t": "Photorealistic 3D Renders", "p": "Interior and exterior still renders — indistinguishable from architectural photography.", "img": "images/studio-kitchen.jpg", "alt": "Photorealistic interior render", "cap": "Photorealistic 3D Renders"},
                {"t": "3D Animations", "p": "Cinematic 30–60 second walkthroughs and flyovers that move the camera through the space.", "img": "images/hero-2.jpg", "alt": "Cinematic walkthrough frame", "cap": "3D Animations"},
                {"t": "360° Virtual Tours", "p": "Interactive tours for pre-sales and marketing — viewers walk a space online, from any device.", "img": "images/project-minimal.jpg", "alt": "Interactive virtual tour still", "cap": "360° Virtual Tours"},
                {"t": "Sciography Studies", "p": "Sun-path and shadow studies for planning approvals and daylight analysis.", "img": "images/project-facade.jpg", "alt": "Shadow study on building facade", "cap": "Sciography Studies"},
                {"t": "Visualization Consultancy", "p": "Advisory for architects and developers on render pipelines, briefs and visualization strategy.", "img": "images/project-urban.jpg", "alt": "Visualization strategy session", "cap": "Visualization Consultancy"},
                {"t": "Design Revisions &amp; Variants", "p": "Iterative rounds and material, colour and finish variants on an approved render.", "img": "images/project-spatial.jpg", "alt": "Material and finish variants", "cap": "Design Revisions &amp; Variants"},
            ],
        },
        ...
        "next": {
            "sub": "Three ways to work with Woodex — visualization sits next to both design and build.",
            "note": "Need the design too? <a href=\"services/office.html\">See Interior Design →</a> &nbsp;·&nbsp; Design and build together? <a href=\"services/turnkey.html\">See Turnkey →</a>",
            "cols": [
                ["3D Studio — this scope", "Visualization only. Renders, animations, tours and studies for any project — yours, or another practice's."],
                ["Interior Design", "The full design service — space planning, concept, working drawings. 3D rendering is included as one stage."],
                ["Turnkey Design &amp; Build", "Design, build and furnish under one contract — with 3D approvals locked before construction begins."],
            ],
        },

        "statement": {
            "h2": "Approve the room. Then build it.",
            "line": "Every material, every finish, every surface — approved in photorealistic 3D before a single wall is built.",
            "form": {
                "submit": "Start a 3D brief",
                "fields": [
                    {"id": "td-name", "name": "name", "label": "Full Name *", "type": "text", "ac": "name", "half": True},
                    {"id": "td-phone", "name": "phone", "label": "Phone Number *", "type": "tel", "ac": "tel", "half": True},
                    {"id": "td-email", "name": "email", "label": "Email Address *", "type": "email", "ac": "email"},
                    {"id": "td-type", "name": "type", "label": "Professional Type *", "type": "select", "ph": "Select…", "options": ["Architect", "Interior designer", "Developer", "Homeowner / investor", "Brand / retailer", "Other"]},
                    {"id": "td-service", "name": "service", "label": "Service Required *", "type": "select", "ph": "Select…", "options": ["Photorealistic renders", "3D animation / walkthrough", "360° virtual tour", "Sciography (shadow study)", "Visualization consultancy"]},
                    {"id": "td-out", "name": "outputs", "label": "Outputs Required *", "type": "select", "ph": "Select…", "options": ["1–5 renders", "6–10 renders", "11+ renders / full project", "Animation — duration to confirm", "Not sure — need guidance"]},
                    {"id": "td-time", "name": "timeline", "label": "Timeline *", "type": "select", "ph": "Select…", "options": ["As soon as possible", "Within 1 week", "Within 2–4 weeks", "Flexible"]},
                    {"id": "td-msg", "name": "message", "label": "Message / Project Details *", "type": "textarea", "ph": "Drawings, references, deadlines…"},
                ],
            },
        },
    },
