...
- ⏳ **Next:** 🔨 services family per `docs/SERVICES_MASTER_PLAN.md` (awaiting 4 owner decisions) → process · contact · start-your-project · faq (conversion core) → locations ×13 → client-stories · woodex-craft · careers → architecture/renovation/rooms expansion (~28)
